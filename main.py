...
# Helpers for saving trades, alerts, errors, etc.
...
# Function to save errors to Firebase as URLs
def save_error_to_firebase(error_message):
    ...
    return error_ref.key  # Unique key generated by Firebase
...
async def setkeys(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        error_url = save_error_to_firebase(str(e))  # Save error and get URL
...
# Main function to start bot and set webhook
async def main():
    global telegram_app
